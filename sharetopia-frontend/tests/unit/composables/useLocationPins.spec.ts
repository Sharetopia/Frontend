...
describe("useLocationPins.ts", () => {
    it("should create Location Pins from productModels", () => {
        ...
        expect(locationPins.value).to.deep.equals(expectedLocationPins, "The location pins does not match");
    });
    ...
    it("should use as center location pin the first product, because this would be the most suitable", () => {
        ...
        expect(centerPin.value).to.deep.equals(expectedLocationPins[0], "The location pins does not match");
    });
});

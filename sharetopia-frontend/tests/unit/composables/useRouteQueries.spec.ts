...
describe("useRouteQueries.ts", () => {
    it("should create a searchModel from locationQuery", () => {
        const locationQuery = {query: 'Fahrrad', radius: '10', postalCode: '71549', start: 'Fri Feb 11 2022', end: 'Fri Feb 11 2022'}
        ...
        expect(searchModel).to.deep.equals(expectedSearchModel, "The search model does not match.");
    });

    it("should not create a searchModel from wrong locationQuery", () => {
        const locationQuery = {query: 'Fahrrad', radius: '10'}
        const { searchModel } = useRouteQueries(locationQuery)
        expect(searchModel).to.deep.equals(undefined, "The search is not undefined");
    });
    ...
    it("should extract the productId from locationQuery", () => {
        ...
        expect(productId).to.deep.equals(expectedValue, "The product id does not match.");
    });
});
